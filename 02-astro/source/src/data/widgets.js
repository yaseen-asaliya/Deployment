// Central registry of IR widgets embedded on the page.
// Each entry maps to a `<div data-widget="${key}">` placeholder that widgets.js
// lazy-mounts via the third-party widget-loader.js from irp.atnmo.com.
...
export const TABS = [
  { id: 'overview',      key: 'overview',       widgets: [{ key: 'company-snapshot',       labelEn: 'Company Snapshot',        labelAr: 'لمحة عن الشركة' }] },
  { id: 'announcements', key: 'corporate-news', widgets: [{ key: 'corporate-news',          labelEn: 'Latest Announcements',    labelAr: 'آخر الإعلانات' }] },
  { id: 'factsheet',     key: 'fact-sheet',     widgets: [
  ...
  { id: 'stockactivity', key: 'stock-activity', widgets: [
  ...
  { id: 'actions',       key: 'corporate-actions',  widgets: [{ key: 'corporate-actions',     labelEn: 'Corporate Actions',     labelAr: 'الإجراءات النظامية' }] },
  { id: 'financials',    key: 'financials',         widgets: [{ key: 'company-financials',    labelEn: 'Company Financials',    labelAr: 'البيانات المالية' }] },
  { id: 'shareprice',    key: 'share-price',        widgets: [{ key: 'share-price',           labelEn: 'Share Price',           labelAr: 'سعر السهم' }] },
  { id: 'performance',   key: 'performance',        widgets: [{ key: 'performance',           labelEn: 'Performance',           labelAr: 'الأداء' }] },
  { id: 'calculator',    key: 'investment-calc',    widgets: [{ key: 'investment-calculator', labelEn: 'Investment Calculator', labelAr: 'حاسبة الاستثمار' }] },
  { id: 'series',        key: 'share-series',       widgets: [{ key: 'share-series',          labelEn: 'Share Series',          labelAr: 'سلسلة الأسهم' }] },
  { id: 'peer',          key: 'peer-group',         widgets: [{ key: 'peer-group-analysis',   labelEn: 'Peer Group Analysis',   labelAr: 'تحليل المجموعة المماثلة' }] },
  { id: 'zakat',         key: 'zakat',              widgets: [{ key: 'zakat-calculator',      labelEn: 'Zakat Calculator',      labelAr: 'حاسبة الزكاة' }] },
  { id: 'subscribe',     key: 'email-sub',          widgets: [{ key: 'email-subscription',    labelEn: 'Email Subscription',    labelAr: 'الاشتراك في النشرة' }] },
];

export const TAB_LABELS = {
  en: {
    overview: 'Overview', announcements: 'Announcements', factsheet: 'Fact Sheet',
    stockactivity: 'Stock Activity', actions: 'Corporate Actions', financials: 'Financials',
    shareprice: 'Share Price', performance: 'Performance', calculator: 'Calculator',
    series: 'Share Series', peer: 'Peer Group', zakat: 'Zakat', subscribe: 'Subscribe',
  },
  ar: {
    overview: 'نظرة عامة', announcements: 'الإعلانات', factsheet: 'نشرة المعلومات',
    stockactivity: 'نشاط السهم', actions: 'الإجراءات النظامية', financials: 'البيانات المالية',
    shareprice: 'سعر السهم', performance: 'الأداء', calculator: 'حاسبة الاستثمار',
    series: 'سلسلة الأسهم', peer: 'تحليل المجموعة المماثلة', zakat: 'الزكاة', subscribe: 'الاشتراك',
  },
};
